...
/* ============================================================
   ...
   ============================================================ */
DB.checklist = {
  depts: ['GENERAL','CASHIER','FV','GROCERY','BUTCHER'],
  deptMeta: {
    GENERAL:{icon:'fa-store',  color:'#4f46e5'},
  ...
  items: [
    // ---- GENERAL ----
    ['GENERAL','All Day','ALL STAFF HAVING PROPER UNIFORM AND NAME BADGE','A',0],
    ['GENERAL','All Day','ALL STAFF WORK THEIR ROSTERED SHIFT AS SCHEDULED','A',0],
    ['GENERAL','Opening','TURN ON MUSIC','O',0],
    ['GENERAL','Opening','SHOP FLOOR LIGHTS TURN ON','O',0],
    ['GENERAL','Opening','BIN AREA EMPTY / TIDY','O','R1-5'],
    ['GENERAL','Opening','MEAT DISPLAY CLEAN AND LABEL CORRECT','O',0],
    ['GENERAL','Opening','CAFE HOMEMADE + SUPPLIER ITEMS CORRECT LABEL AND RIGHT TEMP','O','R1-5'],
    ['GENERAL','Opening','ALL DESIGNATED STAFF HAVING WALKIE-TALKIE DEVICE AND FILLING LOG BOOK PROPERLY','O','R1-2'],
    ['GENERAL','Closing','ALL GATES & ROLLER DOORS CLOSED AND LOCKED','C','O5'],
    ['GENERAL','Closing','BINS ARE EMPTY AND BIN AREA CLEAR','C','R1-2'],
    ['GENERAL','Closing','CHECK ALL FRIDGE & FREEZER TEMP','C','O'],
    ['GENERAL','Closing','CAFE WATER TURN OFF AND ALL APPLIANCES WORKING','C',0],
    ['GENERAL','Closing','SHOP FLOOR LIGHTS TURN OFF','C',0],
    ['GENERAL','Closing','ALL WALKIE-TALKIE DEVICES CHARGED IN DOCKS AND LOG BOOK UP TO DATE','C','R1-2'],
    // ---- CASHIER ----
    ['CASHIER','Customer Service','CUSTOMER SERVICE: GREETING AND SMILING TO CUSTOMERS','A',0],
    ...
    ['CASHIER','Opening','CHECK FRIDGE HOMEMADE TEMP NO.2','O','R1-5'],
    ['CASHIER','Opening','CHECK FRIDGE FRUIT SALAD TEMP NO.1','O','R1-5'],
    ...
    // ---- FV ----
    ['FV','General','FRIDGE TEMPERATURE CHECKED','A','R1-10'],
    ['FV','General','AISLES CLEAR, NO PALLET JACK / BINS BLOCKING','A','R1-10'],
    ...
    ['FV','Fruit & Veges Back Door WH','FRIDGE TEMPERATURE CHECKED','A','R1-5'],
    ...
    ['GROCERY','Frozen & Dairy','FRIDGES ARE CLEAN AND CLEAR. TEMPERATURE CHECKED','A','R1-10'],
    ['GROCERY','Frozen & Dairy','CHECK PRICE LABEL ACCURACY','A',0],
    ['GROCERY','Frozen & Dairy','RANDOM EXPIRY CHECK FOR SHORT-DATED ITEMS. MARKDOWN DONE','A',0],
    ['GROCERY','Frozen & Dairy','KEY VALUE ITEMS ARE FILLED UP','A',0],
    ['GROCERY','Frozen & Dairy','FRONT SHELVES ARE FACED UP WITH LABELS','A',0],
    ['GROCERY','Frozen & Dairy','AISLES CLEAN, NO RUBBISH ON THE WAY','A','R1-5'],
    ['GROCERY','Frozen & Dairy','TOFU QUALITY CHECKED AND CLEAN','A',0],
    // ---- BUTCHER ----
    ['BUTCHER','Retail','FRIDGE AND/OR COLDROOM TEMPERATURE CHECKED','A','R1-10'],
...
DB.navGroups = [
  ...
  { id:'hr',     label:'Staff & HR', icon:'fa-users',          items:['structure','staff','schedule','training','violation','reward','raise','birthday'] },
